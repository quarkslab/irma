...
def upgrade():
    ...
    op.create_index(op.f('ix_irma_file_md5'), 'irma_file', ['md5'], unique=False)
    op.create_index(op.f('ix_irma_file_sha1'), 'irma_file', ['sha1'], unique=False)
    op.create_index(op.f('ix_irma_file_sha256'), 'irma_file', ['sha256'], unique=False)
    ...
    op.create_index(op.f('ix_irma_scan_external_id'), 'irma_scan', ['external_id'], unique=False)
    ...
    op.create_index(op.f('ix_irma_submission_external_id'), 'irma_submission', ['external_id'], unique=False)
    ...
    op.create_table('irma_fileAgent',
                    ...
                    sa.ForeignKeyConstraint(['id_s'], ['irma_submission.id'], ),
                    sa.PrimaryKeyConstraint('id'),
                    sqlite_autoincrement=True
                )
    ...
    op.create_index(op.f('ix_irma_scanEvents_id_scan'), 'irma_scanEvents', ['id_scan'], unique=False)
    ...
    op.create_table('irma_probeResult_fileWeb',
                    ...
                    sa.ForeignKeyConstraint(['id_pr'], ['irma_probeResult.id'], )
                )
...
def downgrade():
    ...
    op.drop_index(op.f('ix_irma_scanEvents_id_scan'), table_name='irma_scanEvents')
    ...
    op.drop_index(op.f('ix_irma_submission_external_id'), table_name='irma_submission')
    op.drop_table('irma_submission')
    op.drop_index(op.f('ix_irma_scan_external_id'), table_name='irma_scan')
    op.drop_table('irma_scan')
    op.drop_index(op.f('ix_irma_file_sha256'), table_name='irma_file')
    op.drop_index(op.f('ix_irma_file_sha1'), table_name='irma_file')
    op.drop_index(op.f('ix_irma_file_md5'), table_name='irma_file')
