...
from lib.irma.common.exceptions import IrmaDatabaseResultNotFound, IrmaDatabaseError
...
class TestFile(TestCase):
    ...
    def test005_classmethod_load_from_sha256_raise_MultipleResultNotFound(self):
        sample = "test"
        session = MagicMock()
