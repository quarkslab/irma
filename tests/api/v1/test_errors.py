...
import frontend.api.v1.errors as api_errors
...
class TestApiErrors(TestCase):
    ...
    @patch("frontend.api.v1.errors.abort")
    @patch("frontend.api.v1.errors.sys")
    ...
    @patch("frontend.api.v1.errors.api_error_schema")
