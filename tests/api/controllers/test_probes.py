...
class TestApiProbes(TestCase):
    ...
    def test001_list_ok(self):
        ...
        self.assertEqual(api_probes.response.content_type, "application/json; charset=UTF-8")
    ...
    def test002_list_error(self):
        ...
        with patch("frontend.api.controllers.probes.celery_brain") as mock_error:
            mock_error.probe_list.side_effect = expected
            with patch("frontend.api.controllers.probes.process_error") as mock:
                result = api_probes.list()
